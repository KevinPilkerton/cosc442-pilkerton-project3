 ...
 *
 * @generatedBy CodePro at 3/3/17 3:21 PM
 * @author Kevin
...
public class VendingMachineTest {
	...
	public void testAddItem_5()
	{
		...
		VendingMachineItem i1 = new VendingMachineItem("", 1.0);
		VendingMachineItem i2 = new VendingMachineItem("", 1.0);
		v.addItem(i1, "A");
		v.addItem(i2, "A");
	}
	...
	public void testRemoveItem_4()
	{
		...
		VendingMachineItem i1 = new VendingMachineItem("", 1.0);
		v.addItem(i1, "A");
		assertEquals(i1, v.removeItem("A"));
	}
